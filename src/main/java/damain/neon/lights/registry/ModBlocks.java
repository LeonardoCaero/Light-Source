...
public class ModBlocks {
    ...
    public static final Block NEON_BAR = new Block(FabricBlockSettings.of(Material.GLASS).breakByHand(true)
            .hardness(0.9f).sounds(BlockSoundGroup.GLASS).luminance(15).nonOpaque());

    public static final Block PRO_BUILD = new Block(FabricBlockSettings.of(Material.GLASS).breakByHand(true)
            .hardness(0.9f).sounds(BlockSoundGroup.GLASS).luminance(15).nonOpaque());
    ...
    public static void registerBlocks() {
        ...
        Registry.register(Registry.BLOCK, new Identifier(NeonLights.MOD_ID, "pro_build"), PRO_BUILD);
